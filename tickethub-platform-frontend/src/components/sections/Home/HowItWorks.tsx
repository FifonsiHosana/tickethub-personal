...
const steps = [
  {
    ...
    description:
      "Browse curated concerts, festivals, and exclusive gatherings tailored to your interests.",
  },
  {
    number: "02",
    title: "Secure your spot",
    description:
      "Frictionless checkout using Mobile Money or cards. Instant confirmation straight to your inbox.",
  },
  {
    number: "03",
    title: "Access instantly",
    description:
      "Your digital ticket is securely stored. Just pull up your QR code at the door and skip the line.",
  },
];
    ...
    <section className="w-full py-24  bg-white/70 overflow-hidden">
      <div className="mx-auto container px-6 lg:px-12 max-w-7xl">
        ...
        >
          ...
          <div className="hidden md:block absolute top-10 left-[10%] right-[10%] h-px bg-primary/20 z-0" />
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <div className="flex items-center mb-8 w-full">
                <div className="w-20 h-20 rounded-full bg-neutral-50 border border-primary flex items-center justify-center shadow-sm group-hover:border-[#1a201c]/20 group-hover:bg-[#1a201c]/5 transition-colors duration-500">
                  <span className="text-3xl text-primary">{step.number}</span>
                </div>
              </div>
              ...
              <p className="text-neutral-500 font-sans text-base leading-relaxed md:max-w-70">
                {step.description}
              </p>
