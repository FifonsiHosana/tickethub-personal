...
const getStatusColor = (status: string) => {
  switch (status) {
    case "Published": return "bg-green-500/15 text-green-700 hover:bg-green-500/25";
    case "Draft": return "bg-slate-500/15 text-slate-700 hover:bg-slate-500/25";
    case "Completed": return "bg-blue-500/15 text-blue-700 hover:bg-blue-500/25";
...
const getApprovalColor = (status: string | null) => {
  switch (status) {
    case "Approved": return "bg-green-500/15 text-green-700 hover:bg-green-500/25";
    case "Pending": return "bg-amber-500/15 text-amber-700 hover:bg-amber-500/25";
    case "Rejected": return "bg-red-500/15 text-red-700 hover:bg-red-500/25";
    default: return "bg-gray-500/15 text-gray-700";
  }
};
...
export function EventsTable({ data, isLoading, page, onPageChange, search, onSearchChange }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-md border border-gray-300 max-h-120 overflow-auto">
        <Table>
          <TableHeader>
            <TableRow>
